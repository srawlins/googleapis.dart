...
void main() {
  ...
  unittest.group('resource-LiveBroadcastsResource', () {
    ...
    unittest.test('method--insertCuepoint', () async {
      ...
      final arg_resource_cueType = 'foo';
      final arg_resource_durationSecs = 42;
      final arg_resource_etag = 'foo';
      final arg_resource_id = 'foo';
      final arg_resource_insertionOffsetTimeMs = 'foo';
      final arg_resource_walltimeMs = 'foo';
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
        ...
        unittest.expect(
          queryMap['resource.cueType']!.first,
          unittest.equals(arg_resource_cueType),
        );
        unittest.expect(
          core.int.parse(queryMap['resource.durationSecs']!.first),
          unittest.equals(arg_resource_durationSecs),
        );
        unittest.expect(
          queryMap['resource.etag']!.first,
          unittest.equals(arg_resource_etag),
        );
        unittest.expect(
          queryMap['resource.id']!.first,
          unittest.equals(arg_resource_id),
        );
        unittest.expect(
          queryMap['resource.insertionOffsetTimeMs']!.first,
          unittest.equals(arg_resource_insertionOffsetTimeMs),
        );
        unittest.expect(
          queryMap['resource.walltimeMs']!.first,
          unittest.equals(arg_resource_walltimeMs),
        );
        unittest.expect(
          queryMap['fields']!.first,
          unittest.equals(arg_$fields),
      ...
      final response = await res.insertCuepoint(
          id: arg_id,
          onBehalfOfContentOwner: arg_onBehalfOfContentOwner,
          onBehalfOfContentOwnerChannel: arg_onBehalfOfContentOwnerChannel,
          part: arg_part,
          resource_cueType: arg_resource_cueType,
          resource_durationSecs: arg_resource_durationSecs,
          resource_etag: arg_resource_etag,
          resource_id: arg_resource_id,
          resource_insertionOffsetTimeMs: arg_resource_insertionOffsetTimeMs,
          resource_walltimeMs: arg_resource_walltimeMs,
          $fields: arg_$fields);
